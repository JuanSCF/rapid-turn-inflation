...
'''
# g=g, fng is smaller than f
# 0.9 and downwards, small differences in the left tail
# g=0.1*g, the difference is slightly bigger
# g=0.09*g, the difference is more pronounced
# g=0.088*g, the peak starts to deform. 0.082*g
#### g=0.08*g, strange stuff right tail
#### g=0.079*g, strange stuff right tailx2
#g=0.075*g to 0.073*g strange stuff only near peak
# g=0.072*g strange stuff near peak, the peaks shifts to the right
# g=0.072*g to 0.055*g strange stuff goes to lower left tail
# g=0.054*g, strange stuff dissapears, the left tail is deformed
# g=0.03-0.04, small differences in the left tail but  different way than 0.9
# g=0.02, almost equal
# g=0.
# 
